...
class SubjectForm extends TStandardForm
{
    ...
    function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_Subject');
        ...
        $this->form->addAction(_t('Back to the listing'), new TAction(array('SubjectList', 'onReload')), 'fa:table blue');
        
        $container = new TVBox;
        $container->style = 'width: 100%';
        $container->add(new TXMLBreadCrumb('menu.xml', 'SubjectList'));
