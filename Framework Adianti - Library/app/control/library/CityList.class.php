...
class CityList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $this->form->addAction(_t('New'),  new TAction(array('CityForm', 'onEdit')), 'fa:plus-square green');
        ...
        $this->datagrid->addQuickAction(_t('Edit'), new TDataGridAction(array('CityForm', 'onEdit')), 'id', 'fa:pencil-square-o blue fa-lg');
