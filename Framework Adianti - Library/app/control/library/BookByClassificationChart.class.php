 ...
 */
class BookByClassificationChart extends TPage
{
    /**
     * Class constructor
     * Creates the page
    ...
    function __construct( $show_breadcrumb )
    {
        ...
        try
        {
            ...
            $raw_data = BookService::getBookByClassification( date('Y') );
            TTransaction::close();
            ...
            $panel = new TPanelGroup(_t('Book') .'/'._t('Classification') . ' - ' . date('Y'));
            ...
            $html->enableSection('main', array('data'   => json_encode($data),
                                               ...
                                               'width'  => '100%',
                                               'height' => '300px',
                                               'title'  => _t('Book') .'/'._t('Classification'),
                                               'ytitle' => 'Book',
